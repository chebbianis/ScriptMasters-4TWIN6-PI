...
import QRCodePage from "@/components/workspace/project/QRCodePage";
import Classification from "@/components/workspace/user/classification";
...
export const protectedRoutePaths = [
  ...
  { path: PROTECTED_ROUTES.PROJECT_QR,element: <QRCodePage /> },  
  { path: PROTECTED_ROUTES.CLASSIFICATION, element: <Classification /> },
