    ...
    const captureAndUpload = async () => {
        ...
        try {
            ...
            try {
                ...
                console.log("Sending face registration request for userId:", userId);
                ...
                console.log("Registration response:", uploadResponse.data);
                ...
                const errorMessage = error.response?.data?.message || "An error occurred during facial registration";
                toast({
                    title: "Registration Error",
