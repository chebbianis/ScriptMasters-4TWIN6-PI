...
import { Search, Plus, Trash2, Pencil, FolderX, QrCode } from "lucide-react";
    ...
    <Card className="shadow-lg">
      <CardHeader>
        <div className="flex justify-between items-center">
          ...
          <Button
            onClick={() => navigate(`/workspace/${workspaceId}/project/create`)}
            variant="default"
          >
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <a
                        onClick={(e) => {
                          e.preventDefault();
                          navigate(
                            `/project/workspace/${workspaceId}/project/${project._id}`
                          );
                        }}
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/workspace/${workspaceId}/project/${project._id}/edit`
                          )
                        }
                      >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/workspace/${workspaceId}/project/${project._id}/qr`
                          )
                        }
                      >
